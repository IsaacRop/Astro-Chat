        ...
        <div className="min-h-screen min-h-[100dvh] bg-background text-foreground flex flex-col overflow-x-hidden">
            ...
            <main className="flex-1 p-4 md:p-8 max-w-4xl mx-auto w-full space-y-8">
                <div className="space-y-2">
                    <h1 className="text-2xl md:text-3xl font-serif font-bold text-foreground">Como usar o Otto</h1>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-6">
                    {/* Guia: Chat */}
                    <section className="bg-card border border-border rounded-2xl p-4 md:p-6 space-y-3 md:space-y-4 hover:border-primary/50 transition-colors">
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 min-w-[40px] rounded-xl bg-primary/10 text-primary flex items-center justify-center">
                                <MessageSquare size={20} strokeWidth={1.5} />
                            </div>
                            <h2 className="text-lg md:text-xl font-serif font-medium">Chat & Conhecimento</h2>
                        </div>
                    ...
                    <section className="bg-card border border-border rounded-2xl p-4 md:p-6 space-y-3 md:space-y-4 hover:border-primary/50 transition-colors">
                        <div className="flex items-center gap-3">
                            ...
                            <h2 className="text-lg md:text-xl font-serif font-medium">Quadro de Tarefas</h2>
                        </div>
                        <p className="text-muted-foreground text-sm">
                    ...
                    <section className="bg-card border border-border rounded-2xl p-4 md:p-6 space-y-3 md:space-y-4 hover:border-primary/50 transition-colors">
                        <div className="flex items-center gap-3">
                            ...
                            <h2 className="text-lg md:text-xl font-serif font-medium">Cadernos Literários</h2>
                        </div>
                        <p className="text-muted-foreground text-sm">
                    ...
                    {/* Dica Extra */}
                    <section className="bg-primary/5 border border-primary/20 rounded-2xl p-4 md:p-6 space-y-3 md:space-y-4">
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 min-w-[40px] rounded-xl bg-primary/20 text-primary flex items-center justify-center">
                                <PlusCircle size={20} strokeWidth={1.5} />
                            </div>
                            <h2 className="text-lg md:text-xl font-serif font-medium text-foreground">Dicas Rápidas</h2>
                        </div>
